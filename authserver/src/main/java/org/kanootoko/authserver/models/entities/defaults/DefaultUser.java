package org.kanootoko.authserver.models.entities.defaults;
...
public class DefaultUser implements User {
    ...
    public DefaultUser(@NotNull @NotEmpty String login, @NotNull @NotEmpty String password,
    ...
    /**
     * passwordOk is a method which returns true if password is the same as user's
     * and false otherwise.
     * 
